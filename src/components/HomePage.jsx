...
const getData = async() => {
    ...
    const querySnapshot = await getDocs(collection(db, "Products","Biryani","nonveg"));
    ...
    // const citiesRef = doc(db, "Products", "Biryani", "nonveg","new");;
            ...
            <div className='HotDealsContainer' onClick={() => {setSearchActive('no')}} >
                <div className='HotDealsPart' >
                    ...
                    <div className='HotDealsPartItems' >
                        <div className='HotDealsItemBox'></div>
                        <div className='HotDealsItemBox' ></div>
                        <div className='HotDealsItemBox' ></div>
                    </div>
                </div>
